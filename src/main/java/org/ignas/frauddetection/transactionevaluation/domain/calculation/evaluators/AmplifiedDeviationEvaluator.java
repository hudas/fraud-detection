 ...
 */
public class AmplifiedDeviationEvaluator implements Evaluator<DeviationStatistics> {
    ...
    public ValueExpectancy evaluate(DeviationStatistics transaction) {
        ...
        float rateOfDeviationFromAverage = (5 * transaction.getValue() - transaction.getAverageValue())
